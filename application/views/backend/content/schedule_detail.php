            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <ol class="breadcrumb border-0 m-0">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('admin/schedule'); ?>">Schedule</a></li>
                    ...
                    <div class="fade-in">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>Edit Time Table Form</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="schedule-form" name="schedule-form" method="post" action="" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $schedule->id; ?>" />
                                    <input type="hidden" name="schedule_link" value="<?php echo $schedule->id; ?>" />
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                var image_link = '<?php echo base_url('uploads/schedule'); ?>/<?php echo $schedule->link; ?>';
                PDFObject.embed(image_link, "#document-preview");

                $("form[name='schedule-form']").submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            ...
                            400: function(request, status, error){
                                Swal.fire({
                                    text: 'unable to save schedule. please try again later.',
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "OK",
                                    customClass: {
