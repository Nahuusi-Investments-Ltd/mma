            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <ol class="breadcrumb border-0 m-0">
                    <li class="breadcrumb-item active"><strong>Privacy Policy</strong></a></li>
                    <!-- Breadcrumb Menu-->
                </ol>
            </div>
        </header>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="list-tab" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="policy" class="table table-separate table-head-custom table-checkable table-hover table-striped" width="100%">
        ...
        <script type="text/javascript">
            var policy_table = null;

            $(document).ready(function(){
                policy_table = $('#policy').DataTable({
                    ajax: {
                        url: '<?php echo site_url('privacy/list'); ?>',
                        dataSrc: "privacies"
                    },
                    columns: [
                        {data: "policy"}
                ...
                $('#policy tbody').on('click', 'tr', function () {
                    window.location.href = window.location.href = '<?php echo site_url('privacy/detail'); ?>?id=' + $(this).data("id");
                });
            });
        </script>
    </body>
