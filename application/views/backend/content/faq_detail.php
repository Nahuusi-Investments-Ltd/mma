            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <ol class="breadcrumb border-0 m-0">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('admin/faq'); ?>">FAQs</a></li>
                    <li class="breadcrumb-item active"><?php echo $faq->title; ?></li>
                    <!-- Breadcrumb Menu-->
                </ol>
            </div>
        </header>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="title" type="text" required="" value="<?php echo $faq->title; ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="message" type="text" required="" value="<?php echo $faq->message; ?>" />
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("form[name='faq-form']").submit(function(e) {
                    ...
                    $.ajax({
                        url: '<?php echo site_url('faq/save'); ?>',
                        type: "POST",
                        data: formData,
                        dataType: "json",
                        ...
                        statusCode: {
                            ...
                            400: function(request, status, error){
                                Swal.fire({
                                    text: 'unable to save faq. please try again later.',
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "OK",
                                    customClass: {
            ...
            function delete_record(){
                Swal.fire({
                    text: "Are you sure you want to delete: <?php echo $faq->title; ?>?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        // set user to delete
                        var settings = {
                            "url": "<?php echo site_url('faq/delete'); ?>?id=<?php echo $faq->id; ?>",
                            "method": "DELETE"
                        };
