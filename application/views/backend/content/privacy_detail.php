            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <ol class="breadcrumb border-0 m-0">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('admin/privacy'); ?>">Privacy Policy</a></li>
                    <li class="breadcrumb-item active">Our Privacy Policy</li>
                    <!-- Breadcrumb Menu-->
                </ol>
            </div>
        </header>
                    ...
                    <div class="fade-in">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>Edit Privacy Policy Form</h1>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="privacy-form" name="privacy-form" method="post" action="">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="detail" role="tabpanel">
                                            <br/>
                                            <!-- privacy -->
                                            <input type="hidden" name="policy" id="content_policy" />
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div id="editor" style="height: 400px;"><?php echo $privacy->policy; ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <br/>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("form[name='privacy-form']").submit(function(e) {
                    var html = quill.root.innerHTML;
                    $('#content_policy').val(html);

                    var formData = new FormData($(this)[0]);
                    var loading = new Loading();

                    $.ajax({
                        url: '<?php echo site_url('privacy/save'); ?>',
                        type: "POST",
                        data: formData,
                        dataType: "json",
                        ...
                        statusCode: {
                            ...
                            400: function(request, status, error){
                                Swal.fire({
                                    text: 'unable to save privacy policy. please try again later.',
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "OK",
                                    customClass: {
