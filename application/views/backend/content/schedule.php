            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <ol class="breadcrumb border-0 m-0">
                    <li class="breadcrumb-item active"><strong>Schedule</strong></a></li>
                    <!-- Breadcrumb Menu-->
                </ol>
            </div>
        </header>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="list-tab" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            <table id="schedules" class="table table-separate table-head-custom table-checkable table-hover table-striped" width="100%">
                                                <thead class="thead-dark">
                                                    <tr>
                                                        <th>Schedule Image</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#schedules tbody').on('click', 'tr', function () {
                    window.location.href = window.location.href = '<?php echo site_url('schedule/detail'); ?>?id=' + $(this).data("id");
                });
            });
        </script>
    </body>
